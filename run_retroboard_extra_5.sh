...
RETROBOARD_DIR="/home/vagrant-old/workspace/fse2019/retroboard"
CONSERVED_DIR="$DESKTOP_DIR/retroboard-baseline-extra-5"
MAX_RUNS=5
...
while [ "$LAST_NUM" -lt "$MAX_RUNS" ]; do
    ...
    while :; do
        ...
        if [[ -d "$DESKTOP_DIR/testretroboardAdaptiveComplete_0" ]]; then
            break
        fi
