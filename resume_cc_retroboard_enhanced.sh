...
# ===== CONFIG =====
SOURCE_DIR="/home/vagrant-cc-enhanced/Desktop/retroboard-enhanced-15-run"
RESULTS_DIR="/home/vagrant-cc-enhanced/workspace/test-generation-results/resultsRetroboard"
CODECOVERAGE_DIR="/home/vagrant-cc-enhanced/workspace/codecoverage"
FINAL_RESULTS_DIR="/home/vagrant-cc-enhanced/Desktop/retroboard-15-run-RESULTS"
...
for run in $(seq $RESUME_FROM $MAX_RUNS); do
    ...
    while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
        ...
        ./run.sh retroboard \
                 "/home/vagrant-cc-enhanced/workspace/test-generation-results/resultsRetroboard/$run" \
    ...
    echo "[DEBUG] Running: ./calculate-auc.sh \"/home/vagrant-cc-enhanced/workspace/test-generation-results/resultsRetroboard/$run/testretroboardLLM_0\""
    ./calculate-auc.sh "/home/vagrant-cc-enhanced/workspace/test-generation-results/resultsRetroboard/$run/testretroboardLLM_0" > "/home/vagrant-cc-enhanced/Desktop/retroboard-15-run-RESULTS/$run/results-auc.txt" 2>&1 || {
        echo "[ERROR] AUC calculation failed for run $run";
        echo "[DEBUG] Contents of results-auc.txt:";
        cat "/home/vagrant-cc-enhanced/Desktop/retroboard-15-run-RESULTS/$run/results-auc.txt" 2>/dev/null || echo "No results-auc.txt file found";
        exit 1;
    }
    ...
    python3 fault-auc.py > "/home/vagrant-cc-enhanced/Desktop/retroboard-15-run-RESULTS/$run/fault-auc.txt" || {
