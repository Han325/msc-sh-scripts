...
# ===== CONFIG =====
SOURCE_DIR="/home/vagrant-cc-enhanced/Desktop/dimeshift-enhanced-extra-5"
...
FINAL_RESULTS_DIR="/home/vagrant-cc-enhanced/Desktop/dimeshift-extra-5-run-RESULTS"
...
for run in $(seq 1 $MAX_RUNS); do
    ...
    ./calculate-auc.sh "/home/vagrant-cc-enhanced/workspace/test-generation-results/resultsDimeshift/$run/testdimeshiftLLM_0" > "/home/vagrant-cc-enhanced/Desktop/dimeshift-extra-5-run-RESULTS/$run/results-auc.txt" 2>&1 || {
        echo "[ERROR] AUC calculation failed for run $run";
        echo "[DEBUG] Contents of results-auc.txt:";
        cat "/home/vagrant-cc-enhanced/Desktop/dimeshift-extra-5-run-RESULTS/$run/results-auc.txt" 2>/dev/null || echo "No results-auc.txt file found";
        exit 1;
    }
    ...
    python3 fault-auc.py > /home/vagrant-cc-enhanced/Desktop/dimeshift-extra-5-run-RESULTS/$run/fault-auc.txt || {
