...
COMPOSE_DIRECTORY="/home/vagrant-code-coverage/workspace/fse2019/${PROJECT_NAME}"
HOST_CODE_DIR="/home/vagrant-code-coverage/Desktop/${PROJECT_NAME}-code"
ORIGINAL_CODE_DIR="/home/vagrant-code-coverage/Desktop/${PROJECT_NAME}-og-code"
