...
for run in $(seq 1 $MAX_RUNS); do
    ...
    ./calculate-auc.sh "/home/vagrant-cc-enhanced/workspace/test-generation-results/resultsRetroboard/$run/testretroboardLLM_0" > "/home/vagrant-cc-enhanced/retroboard-15-run-RESULTS/$run/results-auc.txt" 2>&1 || {
