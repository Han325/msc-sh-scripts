...
# ===== CONFIG =====
SOURCE_DIR="/home/vagrant-code-coverage/Desktop/retroboard-enhanced-15-run"
...
echo "===== STARTING COMPLETE RETROBOARD ANALYSIS FOR $MAX_RUNS RUNS ====="
...
for run in $(seq 1 $MAX_RUNS); do
    ...
    # Create directory structure in resultsRetroboard
    mkdir -p "$RESULTS_DIR/$run/testretroboardLLM_0/main" || {
    ...
    SOURCE_MAIN="$SOURCE_DIR/$run/testretroboardAdaptiveComplete_0/main"
    DEST_MAIN="$RESULTS_DIR/$run/testretroboardLLM_0/main"
